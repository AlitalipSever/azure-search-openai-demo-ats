...
const EXAMPLES: ExampleModel[] = [
    {
        text: "Can you share any success stories or case studies of your digital transformation solutions in action?",
    ...
    { text: "Do you have any references or testimonials from previous clients who have undergone digital transformation with your company?",
